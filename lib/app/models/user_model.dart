...
class User extends Model {
  ...
  User({this.name, this.email, this.password, this.apiToken, this.deviceToken, this.phoneNumber, this.verifiedPhone = false, this.verificationId, this.address, this
      .bio, this.avatar, this.referredBy});
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    if(json['redeem_code'] != null) {
      referredBy = stringFromJson(json, 'redeem_code');
    }
    super.fromJson(json);
  }
