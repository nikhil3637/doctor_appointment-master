                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      PhoneFieldWidget(
                        ...
                        onSaved: (phone) => controller.currentUser.value.phoneNumber = phone?.completeNumber,
                        isLast: false,
                        isFirst: false,
                      ),
                      Obx(() {
                      ...
                      TextFieldWidget(
                        ...
                        hintText: "XXXXX (Optional)".tr,
                        initialValue: controller.currentUser.value.email,
                        onSaved: (input) => controller.currentUser.value.referredBy = input,
