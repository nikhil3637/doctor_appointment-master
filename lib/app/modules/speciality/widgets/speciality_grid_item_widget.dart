...
class SpecialityGridItemWidget extends StatelessWidget {
  ...
  SpecialityGridItemWidget({Key? key,this.speciality,required this.heroTag}) : super(key: key);
        ...
        child: Wrap(
          children: <Widget>[
            Container(
              ...
              child: speciality == null ? SizedBox.shrink() : speciality!.image?.url == null ? SizedBox.shrink() :speciality!.image!.url!.toLowerCase().endsWith('.svg')
                  ? SvgPicture.network(
