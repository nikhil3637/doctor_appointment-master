...
class SpecialityListItemWidget extends StatelessWidget {
  ...
  final String? specialityTypeId;
  final String heroTag;
  final bool expanded;

  SpecialityListItemWidget({Key? key,this.speciality,required this.heroTag,required this.expanded,required this.specialityTypeId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: Ui.getBoxDecoration(
          ...
          gradient: speciality == null ? null : new LinearGradient(
        ...
        child: ExpansionTile(
          ...
          title: InkWell(
              ...
              onTap: () {
                if(specialityTypeId != null) {
                  speciality?.emergency = specialityTypeId;
                  Get.toNamed(Routes.SPECIALITY_CLINICS, arguments: speciality);
                } else {
              ...
              child: Row(
                ...
                children: <Widget>[
                  SizedBox(
                    width: 60,
                    height: 60,
                    child: speciality?.image?.url == null ? SizedBox.shrink() : speciality!.image!.url!.toLowerCase().endsWith('.svg')
                        ? SvgPicture.network(
          ...
          children: List.generate(speciality?.subSpecialities?.length ?? 0, (index) {
            ...
            return GestureDetector(
              onTap: () {
                if(specialityTypeId != null) {
                  _speciality?.emergency = specialityTypeId;
                  Get.toNamed(Routes.SPECIALITY_CLINICS, arguments: _speciality);
                } else {
