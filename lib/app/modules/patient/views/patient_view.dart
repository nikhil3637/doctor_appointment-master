import 'package:doctors_appointments/app/modules/global_widgets/text_fleld_widget/shimmer.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                PhoneFieldWidget(
                  ...
                  onSaved: (phone) => controller.patient.value.phone_number = phone?.completeNumber,
                  onChanged: (phone) => controller.patient.value.phone_number = phone.completeNumber,
                ),
                TextFieldWidget(
                ...
                /// Address
                Obx(() => controller.isAddressLoading.value ?
                TextFieldShimmer() :
                TextFieldWidget(
                  ...
                  suffixIcon: IconButton(icon: Icon(Icons.gps_fixed_outlined),
                    onPressed: () async {
                      controller.isAddressLoading.value = true;
                      final Address? address = await Helper.getCurrentLocation();
                      print(address?.address);
                      if(address?.address != null) {
                        controller.patient.value.address = address?.address;
                      }
                      controller.isAddressLoading.value = false;
                    },
                  ),
                )),
                /// Aadhaar Card
