...
import '../widgets/search_doctors_list_widget.dart';

import 'package:doctors_appointments/app/modules/search/controllers/search_controller.dart' as MyApp;

class SearchView extends GetView<MyApp.SearchController> {
  @override
            ...
            Expanded(
              child: Material(
                ...
                child: TextField(
                  ...
                  decoration: Ui.getInputDecoration(hintText: "Search for home doctor...".tr),
                ),
              ),
            ),
            SizedBox(width: 8),
