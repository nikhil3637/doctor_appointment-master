    ...
    return Scaffold(
        ...
        body: ListView(
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.location_pin, color: Get.theme.focusColor),
                      SizedBox(width: 15),
                      Expanded(
                        child: Text(
                            controller.appointment.value.patient?.address ?? '',
                            style: Get.textTheme.bodyMedium
                          // textAlign: TextAlign.end,
                        ),
                      ),
                  ...
                  Row(
                    children: [
                      Icon(Icons.account_box, color: Get.theme.focusColor),
                      SizedBox(width: 15),
                      Expanded(
                        child: Text('${controller.appointment.value.patient?.age} years old',
                            style: Get.textTheme.bodyMedium
                          // textAlign: TextAlign.end,
                        ),
                      ),
                  ...
                  Row(
                    children: [
                      Icon(Icons.male_rounded, color: Get.theme.focusColor),
                      SizedBox(width: 15),
                      Expanded(
                        child: Text(
                            controller.appointment.value.patient?.gender ?? '',
                            style: Get.textTheme.bodyMedium
                          // textAlign: TextAlign.end,
                        ),
                      ),
            ...
            if(controller.appointment.value.emergency == null)
              Container(
                margin: EdgeInsets.symmetric(horizontal: 20, vertical: 8),
                padding: EdgeInsets.symmetric(vertical: 20, horizontal: 20),
                decoration: Ui.getBoxDecoration(),
            ...
            Obx((){
              if(controller.appointment.value.online ?? false) return SizedBox();
              else {
                return Container(
                margin: EdgeInsets.symmetric(horizontal: 20, vertical: 8),
                padding: EdgeInsets.symmetric(vertical: 20, horizontal: 20),
                            ...
                            return Column(
                              ...
                              children: [
                                (controller.appointment.value.address != null)
                                    ? Text(controller.appointment.value.address?.address ?? '', style: Get.textTheme.titleSmall)
                                    : Text("Your Appointment at The Hospital Address.".tr, style: Get.textTheme.bodyMedium),
                              ],
                            );
                          }),
                        ),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Disease".tr, style: Get.textTheme.bodyLarge),
                  SizedBox(height: 8),
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Obx(() {
                          return Text(controller.appointment.value.hint ?? "".tr, style: Get.textTheme.bodyMedium);
                        }),
                      ),
                    ],
                  ),
