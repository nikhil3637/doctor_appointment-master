...
class SelectDialog<V> extends StatefulWidget {
  SelectDialog({Key? key,required this.items,required this.initialSelectedValue,required this.title,required this.submitText,required this.cancelText}) : super(key: key);
