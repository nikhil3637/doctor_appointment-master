                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        ClinicTilWidget(
                          horizontalPadding: 0,
                          title: Text("Doctors".tr, style: Get.textTheme.titleSmall).paddingSymmetric(horizontal: 20),
                          content: FeaturedCarouselWidget(),
                          actions: [
                            InkWell(
                              onTap: () {
                                Get.toNamed(Routes.CLINIC_DOCTORS, arguments: {
                                  'clinic': _clinic,
                                  'is_emergency': controller.emergency
                                });
            ...
            children: [
              Expanded(
                child: Wrap(
                  ...
                  children: List.from(Ui.getStarsList(_clinic.rate ?? 0))
                    ..addAll([
                      SizedBox(width: 5),
                      Text(
                        "Reviews (%s)".trArgs([_clinic.totalReviews.toString()]),
