          ...
          child: ListView(
            ...
            children: [
              ...
              TextFieldWidget(
                ...
                validator: (input) => input == null ? null : !input.contains('@') ? "Should be a valid email" : null,
              ...
              PhoneFieldWidget(
                ...
                // initialCountryCode: controller.user.value.getPhoneNumber().countryISOCode??"+1",
                initialValue: controller.user.value.getPhoneNumber().number,
                onSaved: (phone) => controller.user.value.phoneNumber = phone?.completeNumber,
              ...
              Obx(() {
                ...
                return TextFieldWidget(
                  ...
                  validator: (input) => (input?.length ?? 0) > 0 && (input?.length ?? 0) < 3 ? "Should be more than 3 letters".tr : null,
