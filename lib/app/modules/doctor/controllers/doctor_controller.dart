...
class DoctorController extends GetxController {
  ...
  Future getDoctor() async {
    try {
      doctor.value = await _doctorRepository.get(getId());
    } catch (e) {
  ...
  Future getReviews() async {
    try {
      reviews.assignAll(await _doctorRepository.getReviews(getId()));
    } catch (e) {
      Get.showSnackbar(Ui.ErrorSnackBar(message: e.toString()));
    }
  }
  ...
  Future getExperiences() async {
    try {
      experiences.assignAll(await _doctorRepository.getExperiences(getId()));
    } catch (e) {
      Get.showSnackbar(Ui.ErrorSnackBar(message: e.toString()));
    }
  }
