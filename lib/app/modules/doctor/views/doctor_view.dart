                    ...
                    actions: [
                      new IconButton(
                        icon: Container(
                          ...
                          child: (_doctor.isFavorite) ? Icon(Icons.favorite, color: Colors.redAccent) : Icon(Icons.favorite_outline, color: Get.theme.hintColor),
                        ),
                        onPressed: () {
                          if (!Get.find<AuthService>().isAuth) {
                            Get.toNamed(Routes.LOGIN);
                          } else {
                            if (_doctor.isFavorite) {
                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_doctor.images?.isNotEmpty ?? false)
                          DoctorTilWidget(
                            horizontalPadding: 0,
    ...
    if (_doctor.clinic?.hasData ?? false) {
      return GestureDetector(
        ...
        child: DoctorTilWidget(
          title: Text("Hospital".tr, style: Get.textTheme.titleSmall),
          ...
          children: [
              ...
              child: BlockButtonWidget(
                  ...
                  onPressed: () {
                    ...
                    Get.toNamed(Routes.BOOK_DOCTOR, arguments: {'doctor': _doctor, 'is_emergency': controller.emergency});
