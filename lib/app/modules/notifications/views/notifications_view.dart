...
import '../widgets/appointment_notification_item_widget.dart';
      ...
      if (!controller.notifications.isNotEmpty) {
        ...
        return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              } else if (_notification.data!['appointment_id'] != null) {
                return AppointmentNotificationItemWidget(notification: _notification);
              } else {
