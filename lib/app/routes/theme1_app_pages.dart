import 'package:doctors_appointments/app/modules/speciality_hospital/page.dart';
...
import '../modules/patient/bindings/patient_form_binding.dart';
...
import '../modules/speciality_hospital/binding.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.PATIENT_FORM, page: () => PatientFormView(), binding: PatientFormBinding()),
    ...
    GetPage(name: Routes.SPECIALITY_CLINICS, page: () => SpecialityHospitalView(), binding: SpecialityHospitalBinding()),
  ];
}
