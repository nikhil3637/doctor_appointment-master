...
class ClinicRepository {
  ...
  Future<List<Doctor>> getDoctors(String clinicId, {int page = 0}) {
  ...
  Future<List<Doctor>> getPopularDoctors(String clinicId, {int page = 0}) {
    return _laravelApiClient.getClinicPopularDoctors(clinicId, page);
  }

  Future<List<Doctor>> getMostRatedDoctors(String clinicId, {int page = 0}) {
    return _laravelApiClient.getClinicMostRatedDoctors(clinicId, page);
  }

  Future<List<Doctor>> getAvailableDoctors(String clinicId, {int page = 0}) {
    return _laravelApiClient.getClinicAvailableDoctors(clinicId, page);
  }

  Future<List<Doctor>> getFeaturedDoctors(String clinicId, {int page = 0}) {
    return _laravelApiClient.getClinicFeaturedDoctors(clinicId, page);
  }

  Future<List<Clinic>> getSpecialityClinics(String specialityId, {int page = 0}) {
    return _laravelApiClient.getSpecialityClinicsWithPagination(specialityId, page);
  }
}
