...
class DoctorRepository {
  ...
  Future<List<Doctor>> getFeatured(String specialityId, {int page = 0}) {
    return _laravelApiClient.getFeaturedDoctors(specialityId, page);
  }

  Future<List<Doctor>> getPopular(String specialityId, {int page = 0}) {
    return _laravelApiClient.getPopularDoctors(specialityId, page);
  }

  Future<List<Doctor>> getMostRated(String specialityId, {int page = 0}) {
    return _laravelApiClient.getMostRatedDoctors(specialityId, page);
  }

  Future<List<Doctor>> getAvailable(String specialityId, {int page = 0}) {
